 ...
 const onScroll = useCallback(event => {
  ...
  return (
    <div className="min-h-screen justify-center w-full overflow-hidden ">
      <div className="h-full w-full bg-[url('/img/bg-1.png')] bg-size-[100%_100%] bg-top bg-no-repeat pb-20 lg:pb-32">
          <Header></Header>
          <Element name="about">
            <Banner></Banner>
          </Element>
      ...
      <div className="h-full w-full bg-[url('/img/bg-2.png')] bg-size-[100%_100%] bg-top bg-no-repeat pb-20 lg:pb-32">
        <Scheme></Scheme>
