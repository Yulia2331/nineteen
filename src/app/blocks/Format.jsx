  ...
  return (
    ...
    <div className="container">    
            ...
            <div className="relative">
                    <div className="py-3 sm:py-5 px-4 sm:px-8 pr-10 bg-white rounded-4xl absolute bottom-5/12 shadow-[0_4px_34px_rgba(36,36,36,0.2)] w-48 sm:w-80 lg:left-10">
                    ...
                    <div className="py-3 sm:py-5 px-4 sm:px-8 pr-10 bg-white rounded-4xl absolute right-14 lg:top-7 shadow-[0_4px_34px_rgba(36,36,36,0.2)] w-48 sm:w-80">
                    ...
                    <div className="py-3 sm:py-5 px-4 sm:px-8 pr-10 bg-white rounded-4xl right-10 absolute sm:right-30 bottom-0 lg:bottom-48 shadow-[0_4px_34px_rgba(36,36,36,0.2)] w-48 sm:w-80">
                ...
                <div className="flex justify-center items-center ">
                    <img className="w-11/12 lg:w-9/12 xl:w-6/12" src="/img/7.png" alt="" />
                </div>
            </div>
         </div>   
        </div>
