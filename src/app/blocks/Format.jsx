  ...
  return (
    ...
    <div className="container">    
            ...
            <div className="relative">
                    <div className="py-3 sm:py-5 px-4 md:px-8 pr-10 bg-white rounded-4xl absolute bottom-5/12 shadow-[0_4px_34px_rgba(36,36,36,0.2)] w-48 sm:w-80">
                    ...
                    <div className="py-3 sm:py-5 px-4 md:px-8 pr-10 bg-white rounded-4xl absolute right-8 top-7 shadow-[0_4px_34px_rgba(36,36,36,0.2)] w-48 sm:w-80">
