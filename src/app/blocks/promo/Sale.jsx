...
export default function Sale() {
  ...
  return (
    <div className={`fade-block ${isVisible ? 'visible' : ''}`}  ref={ref}>
           ...
           <ExportedImage className="z-20 absolute -left-1 bottom-0 h-full" width={926} height={544}  src="/img/promo/line-center.png" alt="Static Image" />
             <ExportedImage className="z-20 w-[265px] xs:w-[260px] sm:w-[400px] md:w-[510px] lg:w-[700px] absolute left-0 bottom-0" width={331} height={544}  src="/img/promo/girl.png" alt="Static Image" />
              <ExportedImage className="max-w-[180px] xs:max-w-[100px] md:max-w-[140px] lg:max-w-full absolute right-0 top-0" width={254} height={312}  src="/img/promo/star-group.svg" alt="Static Image" />
