...
export default function Banner() {
  return (
    ...
    <div className="absolute h-full w-[140%] -right-[75%] scale-115 sm:scale-100 sm:-right-[60%] top-30 xs:top-12 md:top-0 xl:-top-56 "><img src="/img/promo/banner-grad.png" alt="" className="max-h-[1200px]"/></div>
    <div className="container">
        <div className="flex flex-col items-center relative z-20">
            <h1 className="text-2xl xs:text-3xl sm:text-4xl md:text-5xl lg:text-[66px] leading-none tracking-tight font-bold uppercase text-center">
        ...
        <div className="h-full py-6 sm:py-12 xl:py-1 relative z-20">         
            ...
            <div className="text-sm sm:text-lg md:text-xl lg:text-2xl tracking-[-.8] w-96 mb-10 md:mb-26 lg:mb-22">
        ...
        <div className="absolute h-full w-10/12 right-0 -bottom-20 xs:bottom-0 flex flex-col items-center pointer-events-none">           
            <img className="w-[100px] xs:w-[140px] sm:w-[250px] lg:w-[290px] xl:w-[310px] translate-x-10 translate-y-28 sm:translate-y-38 md:translate-y-30 xl:translate-y-28 md:-translate-x-20 lg:-translate-x-20 z-10 animate-bounce-sm" src="/img/promo/big-logo.png" alt="" />
                <img className="w-full scale-100 xs:scale-120 xl:scale-94 md:max-h-[540px] lg:max-h-[580px] translate-x-20 md:translate-x-12 translate-y-22 md:translate-y-14 xl:-translate-y-10 z-20 animate-bounce-hand" src="/img/promo/hand.png" alt="" />
            </div>
    </div>
    );
}