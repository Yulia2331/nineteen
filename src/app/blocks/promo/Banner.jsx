...
export default function Banner() {
  return (
    ...
    <div className="absolute h-full w-full right-0 top-46 scale-200 rotate-30 lg:hidden"><ExportedImage className="max-h-[1200px]" width={1447} height={630}  src="/img/numbers-bg.png" alt="Static Image" /></div>
     <div className="absolute h-full w-full right-0 top-46 scale-200 opacity-60 -rotate-30"><ExportedImage className="max-h-[1200px]" width={1447} height={630}  src="/img/numbers-bg.png" alt="Static Image" /></div>
    <div className="absolute h-full w-[140%] -right-[75%] scale-145 sm:scale-100 sm:-right-[60%] top-40 md:top-0 xl:-top-56 ">
        <ExportedImage className="max-h-[1200px]" width={1920} height={1920}  src="/img/promo/banner-grad.png" alt="Static Image" />
        {/* <img src="/img/promo/banner-grad.png" alt="" className="max-h-[1200px]"/> */}
        </div>
    <div className="container">
        ...
        <div className="h-full py-6 sm:py-12 xl:py-1 relative z-20">         
            <div className="flex flex-col md:flex-row justify-between md:items-center">
                <ExportedImage className="w-40 sm:w-56 md:w-64 lg:w-80 order-2 md:order-1" width={379} height={296}  src="/img/promo/gift.png" alt="Static Image" />
        ...
        <div className="absolute h-full w-10/12 right-0 -bottom-20 xs:bottom-0 flex flex-col items-center pointer-events-none">               
            <ExportedImage className="w-[168px] xs:w-[200px] sm:w-[260px] lg:w-[290px] xl:w-[310px] translate-x-5 xs:translate-x-0 translate-y-38 xs:translate-y-44 sm:translate-y-48 md:translate-y-30 xl:translate-y-28 md:-translate-x-20 lg:-translate-x-20 z-10 animate-bounce-sm" width={420} height={316}  src="/img/promo/big-logo.png" alt="Static Image" />
