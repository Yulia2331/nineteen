...
const [vis3, setVis3] = useState(false);
 ...
 <ParallaxProvider>
    ...
    <div className="container">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold uppercase tracking-[-1] md:tracking-[-2] text-center mb-8">Как устроена работа внутри</h2>
          ...
          pr-20 ${vis1 ? 'text-darck border-darck' : 'text-darck-op border-darck-op'}
           `}>
                ...
                <div className="md:w-4/6 lg:w-1/2 lg:pr-20">  
                    <p  className="text-lg xs:text-xl sm:text-2xl md:text-3xl tracking-tight">Над проектом работает команда, которая отвечает за стратегию, дизайн, разработку, привлечение и аналитику.</p>
                </div>
           </div>
           ...
           `}>
                ...
                <div className="md:w-4/6 lg:w-1/2 lg:pr-20">
                    <p className="text-lg xs:text-xl sm:text-2xl md:text-3xl tracking-tight ">Работа идет по единым стандартам: чек-листы, общий список задач, зафиксированные решения.</p>
                </div>
           </div>
             ...
             `}>
                ...
                <div className="md:w-4/6 lg:w-1/2 lg:pr-20">
                    <p className="text-lg xs:text-xl sm:text-2xl md:text-3xl tracking-tight ">Свой маркетинг мы выстраиваем по тем же принципам. Это наш стандарт качества.</p>
                </div>
           </div>
              <Parallax speed={-17}>
