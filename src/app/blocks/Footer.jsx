...
export default function Footer() {
  return (
<footer className="w-full pt-20 pb-10 bg-[url('/img/footer.png')] bg-size-[100%_100%] bg-top bg-no-repeat">
<div className="container">
    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 lg:gap-14">
        <div className="">
          ...
          <div className="">
            ...
            <ul>
                <li className="mb-2 text-sm sm:text-[16px] text-white"><a  href="">Email: info@19bees.com</a></li>
                <li className="mb-2 text-sm sm:text-[16px] text-white"><a  href="tel:89174351919">Телефон: +7 (917) 435-
19-19</a></li>
                ...
                <li className="mb-2 text-sm sm:text-[16px] text-white flex gap-5"><a href="https://wa.me/37259002425" target="_blank">WhatsApp</a><a href="" target="_blank">LinkedIn</a></li>
                <li className="mb-2 text-sm sm:text-[16px] text-white flex"><a href="" target="_blank">YouTube</a></li>
            </ul> 
        </div>
    </div>
    <div className="flex flex-wrap gap-4 md:gap-16 mt-10 md:mt-16">
        <span className="text-white-op-30 text-sm sm:text-[16px]">2025, 19BEES.</span>
