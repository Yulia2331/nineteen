    ...
    <div className="container">
        <div className="mb-3">
            ...
            <div className="grid md:grid-cols-3 gap-3">
                <div className="p-4 lg:px-8 lg:p-6 xl:pr-20 bg-white rounded-4xl">
            ...
            <div className="bg-linear-to-r from-blue-400 to-blue-600 mt-3 rounded-4xl rounded-tr-[100px] rounded-bl-[100px] p-6 px-8 sm:grid grid-cols-2  lg:grid-cols-3 min-h-74 w-full overflow-hidden relative">
