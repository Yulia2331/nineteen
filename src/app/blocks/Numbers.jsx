export default function Numbers() {
  return (
    <div className="container">    
        <div className="pb-20 lg:pb-36 h-full w-full bg-[url('/img/numbers-bg.png')] bg-size-[100%_100%] bg-center bg-no-repeat">
            ...
            <div className="grid md:grid-cols-3 items-start gap-3 lg:gap-5">
                <div className="py-5 px-2 lg:px-8 xl:pr-10 bg-white rounded-4xl shadow-[0_4px_34px_rgba(36,36,36,0.2)]">
                    ...
                    <p className="text-lg  md:text-xl xl:text-2xl tracking-[-1.2] mt-4 whitespace-nowrap">заявок</p>
                </div>
                 <div className="py-5 px-2 lg:px-8 xl:pr-10 bg-white rounded-4xl md:mt-8 lg:mt-14 shadow-[0_4px_34px_rgba(36,36,36,0.2)]">
                    ...
                    <p className="text-lg  xl:text-2xl tracking-[-1.2] mt-4 whitespace-nowrap">стоимости лида</p>
                </div>
                 <div className="py-5 px-2 lg:px-8 xl:pr-10 bg-white rounded-4xl shadow-[0_4px_34px_rgba(36,36,36,0.2)]">
                    ...
                    <p className="text-lg  md:text-xl xl:text-2xl tracking-[-1.2] mt-4 whitespace-nowrap">рост входящих обращений</p>
                </div>
            </div>
