...
export default function Numbers() {
  ...
  return (
    ...
    <div className="container">    
        <div className="pb-20 lg:pb-26 h-full w-full bg-[url('/img/numbers-bg.png')] bg-size-[100%_100%] bg-center bg-no-repeat">
            <div className="mb-10 ">
            ...
            <div className="mt-12 flex flex-col items-center">
                ...
                <div className="flex gap-2 mt-8 flex-wrap">
                    <span className="text-sm md:text-[16px] lg:text-2xl py-2 px-3 lg:px-5 border-2 border-darck-op rounded-4xl">Один менеджер</span>
                    <span className="text-sm md:text-[16px] lg:text-2xl py-2 px-3 lg:px-5 border-2 border-darck-op rounded-4xl">Одна система</span>
                    <span className="text-sm md:text-[16px] lg:text-2xl py-2 px-3 lg:px-5 border-2 border-darck-op rounded-4xl">Единая отчётность</span>
                </div>
            </div>
         </div>   
    </div>
