...
const fetchPost = () => {
    ...
    axios
      .get(`https://back.19bees.ru/wp-json/wp/v2/pages/?slug=${props.slug}`)
      .then((res) => {
        setPost(res.data[0]);
      });
  }
  ...
  return (
    <div className="min-h-screen justify-center w-full overflow-hidden relative">   
       ...
       <div className="container">
        ...
        <div className="text-lg leading-6 flex flex-col gap-4 text-content pb-5" dangerouslySetInnerHTML={{__html: post.content.rendered}}></div>
       </div>
        <Footer></Footer>
    </div>
  );
