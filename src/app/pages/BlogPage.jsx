...
const fetchPosts = () => {
    ...
    axios
      .get(`https://back.19bees.ru/wp-json/wp/v2/posts/`)
      .then((res) => {
        setPosts(res.data);
      });
  }
  ...
  return (
    <div className="">       
        ...
        {posts.map((n, i) => ( 
          ...
          <CaseItemCat key={i} link={`/blog/${n.slug}`} title={n.title.rendered} img={n.cases_prew} descr={n.cases_shortdescr}/>
        ))
           }
       </div>
       {posts.length >= 6 && (
  ...
  return (
    <div className="">
      ...
      <div className="container">
        ...
        <a href="/blog" className="text-[16px]text-darck">Блог</a>
    </div>
      </div>
  ...
  <div className="marquee__track">
    <div className="marquee__content flex items-center gap-5">
          <img src="/img/logo.svg" alt="" className="w-24"/>
              <span className="text-[87px] font-bold uppercase">Блог</span>
            <img src="/img/logo.svg" alt="" className="w-24"/>
              <span className="text-[87px] font-bold uppercase">Блог</span>
            <img src="/img/logo.svg" alt="" className="w-24"/>
              <span className="text-[87px] font-bold uppercase">Блог</span>
