  ...
  <div className="relative">
    ...
    <div className="container">
      ...
      <div className="px-5 md:px-0 md:pl-5">
        <div className="text-xl flex flex-col gap-4 text-content" dangerouslySetInnerHTML={{__html: post.content.rendered}}></div>
...
{!post.cases_vid_prew && (
 ...
 {post.cases_vid_prew && (
                 <video autoPlay loop muted playsInline preload="none" className="w-full ">
                   <source src={post.cases_vid_prew} type="video/mp4" />
                 </video> 
                 )} 
  {!post.cases_vid_prew && (
